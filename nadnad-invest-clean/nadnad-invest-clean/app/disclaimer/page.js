      ...
      <div className="nanad-dashboard-shell">
        <section className="nanad-dashboard-welcome">
          ...
          <h1 className="nanad-dashboard-heading">
            Disclaimer · Pernyataan Penyangkalan Dompet Nadnad
          </h1>
          <p className="nanad-dashboard-body">
            Informasi berikut menjelaskan batasan tanggung jawab dan ruang
            lingkup penggunaan <strong>Dompet Nadnad</strong>. The information
            below explains the limits of liability and scope of use for{" "}
        ...
        <section className="nanad-dashboard-deposits">
          <div className="nanad-dashboard-deposits-header">
            ...
            <p>
              Ringkasan penyangkalan yang berlaku bagi seluruh pengguna{" "}
              <strong>Dompet Nadnad</strong>. Ini bukan nasihat hukum atau
          ...
          >
            ...
            <ul style={{ paddingLeft: "1.1rem" }}>
              <li>
                Dompet Nadnad tidak memberikan rekomendasi investasi, saran
            ...
            <ul style={{ paddingLeft: "1.1rem" }}>
              <li>
                ...
                <strong>Dompet Nadnad</strong> sepenuhnya merupakan{" "}
            ...
            <ul style={{ paddingLeft: "1.1rem" }}>
              ...
              <li>
                Aplikasi dapat mengalami downtime, keterlambatan respons, atau
            ...
            <ul style={{ paddingLeft: "1.1rem" }}>
              <li>
                Dompet Nadnad tidak menggantikan fungsi mutasi rekening bank,
        ...
        <section className="nanad-dashboard-deposits">
          <div className="nanad-dashboard-deposits-header">
            ...
            <p>
              Summary of the disclaimer applicable to all{" "}
              <strong>Dompet Nadnad</strong> users. This is not legal,
          ...
          >
            ...
            <ul style={{ paddingLeft: "1.1rem" }}>
              <li>
                Dompet Nadnad does not provide investment recommendations or
                advice to buy, sell, or hold any financial instrument.
              </li>
              <li>
                Information shown in the app (balances, notes, charts,
                transaction history) is illustrative and administrative only,
                not a forecast of returns or a guarantee of profit.
              </li>
            </ul>
            ...
            <ul style={{ paddingLeft: "1.1rem" }}>
              <li>
                All financial decisions made based on records stored in{" "}
                <strong>Dompet Nadnad</strong> are the{" "}
            ...
            <ul style={{ paddingLeft: "1.1rem" }}>
              <li>
                Dompet Nadnad does not replace official bank statements,
                reports from financial institutions, or other legal documents.
              </li>
              <li>
